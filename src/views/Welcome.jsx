  ...
  return (
    <div style={{ width: "850px", backgroundColor: "#FFFFFF" }}>
      ...
      <div className="mt-12 flex flex-col items-center justify-center text-center pb-12">
        <h1 className="w-72 text-xl font-semibold">{__("One Dashboard. Unlimited Websites. Any Platform.", "surefeedback")}</h1>
        <p className="mt-2 w-120 text-sm font-normal text-text-tertiary ">{__("Once installed on WordPress, SureFeedback works on unlimited websites, ANY platform. Central dashboard management included.", "surefeedback")}</p>
        <img
